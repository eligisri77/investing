...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    outgoing = [
        ...
        },
        {
            ...
            "parts": [
                "תמונת PNG — כרטיס קוביות «החלפה הושלמה» (כיתוב קצר; הפרטים בתוך התמונה)",
                "מכרת · SYMBOL — גיבור «ערך $…»; בתיאור: מחיר למניה ורווח/הפסד אם יש",
                "קנית · SYMBOL — גיבור «ערך $…»; בתיאור: מחיר למניה ומספר מניות משוער",
                "מזומן פנוי — אחרי ההחלפה; אם נשאר מספיק מזומן: הצעה להוסיף למניה בתיק",
                "אם התמונה נכשלת — טקסט HTML עם אותן תוויות (מכרת / קנית / מזומן פנוי · ערך · מחיר)",
            ],
        },
        {
            "icon": "🗓️",
    ...
    return {
        ...
        "getting_started": [
            ...
            },
            {
                ...
                "title": "החלפה מהירה",
                "detail": (
                    "מכירה וקנייה במכה אחת — בלי שלבים נפרדים. "
                    "אחרי הביצוע: כרטיס קוביות «החלפה הושלמה» "
                    "(מכרת · ערך / קנית · ערך / מזומן פנוי)."
                ),
                "cmd": "החלף LABU HOOD",
            },
        ],
        ...
        "commands": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"cmd": "150", "desc": "לקנות בסכום מדויק ממזומן (גם $150) — לא הסכום המומלץ"},
                    {
                        "cmd": "החלף LABU HOOD",
                        "desc": (
                            "כשאין מזומן (או במקביל לקנייה) — מוכר LABU וקונה את המוצעת; "
                            "תשובה: כרטיס «החלפה הושלמה» (מכרת / קנית / מזומן פנוי)"
                        ),
                    },
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"cmd": "מכור 50% LABU", "desc": "למכור חלק מהפוזיציה"},
                    {
                        "cmd": "החלף LABU HOOD",
                        "desc": (
                            "מכירה מלאה + קניית מניה אחרת → כרטיס קוביות «החלפה הושלמה» "
                            "(מכרת · ערך + מחיר למניה / קנית · ערך + מחיר למניה / מזומן פנוי)"
                        ),
                    },
                ],
            },
            {
                ...
                "warning": "רק אם נשלח כרטיס PNG «שלב 2 — חלוקת הון» (לא אחרי הכל הרגיל)",
                "items": [
