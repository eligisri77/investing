...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    outgoing = [
        ...
        },
        {
            ...
            "parts": [
                "גרף PNG למניה (כולל «שיטת כניסה» + בפתיחה/בפריצה), ואז כרטיס קוביות «הצעה N/M» "
                "(שיטת כניסה · ציון ותנודתיות · מומנטום ומחיר · נפח · חדשות ומקורות · בדיקה לאחור — "
                "כותרת + הסבר קצר + ערכים בכל קוביה), ואז הודעת HTML קצרה: שיטה + מזומן + כן/קנה/סכום/דלג "
                "(בלי חומת הסבר בטקסט)",
                "תשובה: כן / קנה (בסכום המוצע) · סכום (למשל 150 או קנה 150) · דלג",
