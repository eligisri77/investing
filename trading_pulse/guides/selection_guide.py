    ...
    user_flow = [
        {
            ...
            "detail": (
                ...
                "(גרף + ציון + הסבר + מזומן פנוי + סכום מומלץ לכל מניה); "
                "עונים כן / סכום / דלג ועוברים להצעה הבאה. "
    ...
    return {
        ...
        "pipeline": [
            ...
            },
            {
                ...
                "detail": (
                    "בטלגרם: גרף + כרטיס «הצעה N/M: SYMBOL» (ציון, הסבר, מזומן פנוי, סכום מומלץ) "
                    "או בדשבורד (#/plan) — עונים כן (במחיר המומלץ) / סכום מדויק / דלג, ועוברים להצעה הבאה. "
