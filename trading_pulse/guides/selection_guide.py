    ...
    user_flow = [
        {
            ...
            "detail": (
                ...
                "עונים כן / קנה / סכום / החלף / דלג ועוברים להצעה הבאה. "
                "«החלף FROM TO» כש־TO היא ההצעה = אישור (מוכר עכשיו · מאשר קנייה בפתיחה) "
        ...
        "pipeline": [
            ...
            },
            {
                ...
                "detail": (
                    ...
                    "או בדשבורד (#/plan) — עונים כן / קנה (בסכום המומלץ) / סכום מדויק / החלף / דלג. "
                    "כל הצעה מושווית להחזקות: יש מזומן — קנייה ממזומן ו/או החלפת החזקה חלשה; "
                    "מזומן $0 — לא מציעים קנייה ב־$0, רק «החלף FROM TO» כשהציון ברור (~2+), או דלג. "
                    "«כן» בלי מזומן מציע פקודת החלף במקום לאשר $0. "
                    "«החלף FROM TO» על ההצעה הנוכחית = אישור ועוברים הלאה "
