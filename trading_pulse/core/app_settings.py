    ...
    },
    {
        ...
        "fields": [
            ...
            },
            {
                ...
                "label": "מזומן מינימלי להצעת פריסה (מעקב שעתי, $)",
                "type": "number",
                "min": 5,
                "max": 500,
                "step": 5,
                "default": 20,
                "hint": (
                    "מזומן פנוי ≥ סף זה → בכל בדיקה שעתי: הצעת קנייה חדשה "
                    "(יש מקום + מניה חזקה) או תקנה להחזקה הכי חזקה"
                ),
            },
            {
            ...
            },
            {
                ...
                "default": True,
                "hint": (
                    "אחרי ציון מגמה+תיקון (מעל MA20 + תיקון קצר, לא רדיפה אחרי שיא) — "
                    "מעדיפים מניות עם Rising Three / נרות סיניים 2 / ניסיוניות פעילות"
                ),
            },
        ],
    },
        ...
        "fields": [
            {
                ...
                "hint": (
                    "קובע אילו שיטות מחפשות מועמדות. "
                    "ציון «מומנטום וציון» = מגמה מעל MA20 + תיקון קצר (לא רדיפה אחרי שיא). "
                    "פרופיל הסיכון נקבע בנפרד"
                ),
            },
            {
                "key": "risk_profile",
            ...
            },
            {
                ...
                "type": "boolean",
                "default": True,
                "hint": "טריגרים ממתינים לפריצה + HTF באותו כיוון + שרוול סיכון (עד כמה הצעות — למטה)",
            },
            {
                "key": "method2_scan_cap",
                "label": "נרות סיניים 2 — כמה מניות לסרוק",
                "type": "number",
                "min": 60,
                "max": 420,
                "step": 20,
                "default": 200,
                "hint": "קודם רשימת השבוע, ואז השלמה מהיקום המלא עד המכסה (ברירת מחדל 200)",
            },
            {
                "key": "method2_max_offers",
                "label": "נרות סיניים 2 — כמה הצעות בתוכנית",
                "type": "number",
                "min": 1,
                "max": 3,
                "step": 1,
                "default": 3,
                "hint": "מקסימום 3 סטאפים מובילים; כפוף למקומות פנויים בתיק",
            },
            {
