    ...
    return {
        ...
        "user_flow": [
            {
                ...
                "title": "ערב — תוכנית",
                "detail": (
                    f"~{plan_dual}: כרטיס PNG «תוכנית למחר» (טבלאות HTML עם כותרות עבריות) "
                    "+ תמונת תיק + גרף לכל מניה (רצועת פרטים בעברית מתחת לגרף בתוך ה־PNG · "
                    "כיתוב טלגרם קצר בלבד, למשל «#1 CLF» · מחיר תחתון עם מינוס לפני: -12%); "
                    "שלח הכל לאישור (HTML טקסט רק אם התמונה נכשלת)."
                ),
            },
            {
                "step": "ב",
                "title": "בוקר — כניסה",
                "detail": (
                    f"~{entry_dual}: קנייה במחיר פתיחה — תמונת טבלת HTML "
        ...
        "pipeline": [
            ...
            },
            {
                ...
                "title": "אישור שלך",
                "detail": (
                    "בטלגרם: כרטיס PNG «תוכנית למחר» (+ תיק + גרף לכל מניה עם פרטים בתמונה · "
                    "כיתוב «#1 CLF») או בדשבורד (#/plan) — "
                    "שלח הכל לאישור. "
                    "אחרי אישור מלא: «תוכנית מאושרת» עם קניות ממזומן, מה שנשאר בתיק, "
                    "וטיפים ידניים להעתקה (בלי פקודה כפולה); כניסה לשוק — ישראל קודם "
                    "(‎16:35‎ ישראל). "
