...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    tips = [
        ...
        "יש מזומן פנוי (~$20+)? הבוט מציע מה לעשות — כולל להוסיף למניה בתיק עם תקנה 1 $50.",
    ...
    return {
        ...
        "getting_started": [
            ...
            },
            {
                ...
                "detail": (
                    "יש מזומן? שלח הכל לקניות חדשות, או תקנה להוסיף למניה שכבר בתיק. "
        ...
        "commands": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"cmd": "תקנה 1 $20", "desc": "להוסיף $20 למניה #1 שכבר בתיק (ממזומן פנוי)"},
        ...
        "examples": [
            ...
            },
            {
                ...
                "steps": ["תקנה 1 $50"],
                "note": (
                    "כשיש מזומן פנוי הבוט מציע מה לעשות: להוסיף למניה בתיק, "
                    "הכל לקניות חדשות שאושרו, או להשאיר במזומן."
                ),
            },
        ],
        "tips": tips,
