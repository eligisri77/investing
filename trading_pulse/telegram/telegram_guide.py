...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    flow = [
        ...
        },
        {
            "time": _dual(sim_t),
            "label": "דוח יומי",
            "detail": "סגירת יום · מכירות ידניות ואוטומטיות + רווח עתידי על מניות פתוחות",
        },
        {
            "time": _dual(heartbeat_t),
            "label": "בדיקת פעילות",
            "detail": "אישור שהסוכן חי; בסוף שבוע מציג שהשוק סגור ומתי צפויה התוכנית הבאה",
        },
    ]
    if enabled:
        flow.insert(
    ...
    outgoing = [
        ...
        },
        {
            ...
            "parts": [
                "הון בתחילת/סוף היום וסך השינוי הממומש",
                "רווח עתידי על מניות שעדיין מוחזקות",
                "מכירות ידניות מוצגות בנפרד מסגירות אוטומטיות",
            ],
        },
        {
            "icon": "💚",
            ...
            "parts": [
                "הון נוכחי, פרופיל סיכון וסיכום מצב בעברית",
        ...
        },
        {
            ...
            "when": "כששולחים תיק",
            "parts": [
                "תמונת טבלה עם פוזיציות ורווח לפי מניה",
    ...
    if enabled:
        outgoing.insert(
            5,
            {
                ...
                "parts": [
                    "מצב מניות מושקעות — מחיר; «מהכניסה» מול «היום»",
                    "חריגות: מתחת למחיר תחתון, קרוב לרף, ירידה חדה",
                    "מכירה אוטומטית כשהמחיר יורד מתחת לרף",
                    "הצעות: רכישה אם יש מקום בתיק, החלפה אם התיק מלא (+ איך לבצע)",
    ...
    tips = [
        ...
        "ציון שעתי / מעקב שיטה 2: עדכונים שקטים + מרחק לפריצה; המעקב נעצר אחרי מכירה או כשהפוזיציה נעלמת.",
                ...
                "items": [
                    ...
                    {"cmd": "ציון AAPL", "desc": "אותו דבר — ציון וכל נתוני ההחלטה"},
                    {
                        ...
                        "desc": (
                            ...
                            "בשיטה 2 — גם מרחק לפריצה; נעצר אחרי מכירה / כשאין פוזיציה"
                        ),
                    },
