...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    outgoing = [
        ...
        },
        {
            ...
            "parts": [
                ...
                "אם נשארו פעולות ידניות (מכירה/החלפה מהתוכנית) — תזכורת עם פקודות להעתקה (למשל מכור PATH / החלף PYPL …)",
    ...
    tips = [
        ...
        "מכירה U / מכיר U → שאלת אישור; אז כן / אישור (או מכור U). מכור U מבצע מיד.",
        "סכומי הדולר בתוכנית = מה ש«הכל» יקצה לקניות ממזומן (החלפות/מכירות נשארות ידניות).",
        "ציון שעתי / מעקב שיטה 2: עדכונים שקטים יותר + מרחק לפריצה; שורט = רווח כשהמחיר יורד.",
    ...
    return {
        ...
        "commands": [
            ...
            },
            {
                ...
                "warning": (
                    "מכירה U / מכיר U = שאלת אישור בלבד. "
                    "אשר עם כן / אישור, או שלח מכור U לביצוע מיידי"
                ),
                "items": [
                    {"cmd": "תיק", "desc": "תמונת תיק עם מספרים לכל מניה (#1, #2…)"},
                    {"cmd": "מכירה LABU", "desc": "שאלת אישור — אחר כך כן / אישור (או מכור LABU)"},
                ...
                "items": [
                    ...
                    {"cmd": "ציון AAPL", "desc": "אותו דבר — ציון וכל נתוני ההחלטה"},
                    {
                        ...
                        "desc": (
                            ...
                            "בשיטה 2 — גם מרחק לפריצה; שורט = רווח בירידה"
                        ),
                    },
