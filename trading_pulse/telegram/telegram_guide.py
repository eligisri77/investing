    ...
    outgoing = [
        {
            ...
            "parts": [
                ...
                "סכומי $ בתוכנית = מה ש«הכל» יחלק לקניות ממזומן",
                "כשיש מזומן פנוי (~$20+) — הצעה מה לעשות איתו (כולל תקנה למניה בתיק)",
                "כשאין קנייה — הסבר אם הסיבה היא איכות, אות כניסה, מזומן, מקום בתיק או מצב השוק",
                "הצעות החלפה בערב מוגבלות (עד ~2, בלי כמה לאותו יעד)",
                "אחרי פעולה ידנית — מצוין אם התוכנית עודכנה או שהזמנה שכבר אושרה נשארה ללא שינוי",
        ...
        },
        {
            ...
            "parts": [
                ...
                "אם נשארו פעולות ידניות — תזכורת רק למניות שעדיין מוחזקות (לא לכאלה שכבר נסגרו)",
        ...
        },
        {
            ...
            "parts": [
                "נסרקו בהצלחה X מתוך Y · נבחרו לפי גודל הרשימה בהגדרות (למשל 60)",
                "בטלגרם: Top 10 + «ועוד N» — הרשימה המלאה בדשבורד / config",
                "דירוג: מומנטום + תנודתיות + נפח (+ אותות אסטרטגיה אם מופעל)",
                "התוכנית היומית תסרוק רק את הרשימה הזו",
            ],
        },
        {
            "icon": "📋",
