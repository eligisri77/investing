...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    flow = [
        {
            ...
            "detail": (
                ...
                "יש תיק: תמונת קוביות לכל החזקה + רצועת פעולה — ואם יש מניות חדשות, "
                "הצעות אחת-אחת אחרי הסקירה"
            ),
        },
        {
            "time": _dual(entry_t),
    ...
    outgoing = [
        ...
        },
        {
            ...
            "parts": [
                "תמונת PNG — קוביית מדדים מסומנת לכל החזקה: הון מושקע · PnL% · ציון · המלצה "
                "(החזק / מכור / החלף / ממש רווח)",
                "החלפה לפי ציון: אם מניה חדשה מנצחת החזקה בכ־2+ נקודות ציון — מומלץ "
        ...
        },
        {
            ...
            "parts": [
                ...
                "(שיטת כניסה · ציון · מומנטום · נפח · חדשות · בדיקה לאחור) וגם את הפעולה "
                ...
                "מזומן $0: לא מציעים קנייה ב־$0 — מימון רק בהחלף/מכור עם סימבולים אמיתיים מהתיק "
                "(למשל החלף AMZN TSLL · מכור AMZN), או דלג",
                "«כן» בלי מזומן לא מאשר קנייה ב־$0 — הבוט מציע במקום החלף עם סימבולים מהתיק",
                "אישור כמה הצעות ממזומן: כל אישור מוריד מהמזומן הפנוי — "
                "אי אפשר לבזבז את אותו מזומן פעמיים",
                "תשובה: כן / קנה (בסכום המוצע) · סכום (למשל 150 או קנה 150) · "
                "החלף כמו בכרטיס · דלג",
    ...
    tips = [
        ...
        (
            ...
            "מזומן $0: כן לא מאשר קנייה — בכרטיס מופיעות פקודות עם סימבולים מהתיק, אחרת דלג. "
                ...
                "items": [
                    {
                        "cmd": "כן",
                        "desc": (
                            "לקנות ממזומן בסכום המומלץ; בלי מזומן — הבוט מציע בכרטיס "
                            "החלף/מכור עם סימבולים מהתיק (למשל החלף AMZN TSLL) במקום לאשר $0"
                        ),
                    },
                    {"cmd": "150", "desc": "לקנות בסכום מדויק ממזומן (גם $150) — לא הסכום המומלץ"},
                    {
                        "cmd": "החלף LABU HOOD",
                        "desc": (
                ...
                "items": [
                    ...
                    {"cmd": "מכור 50% LABU", "desc": "למכור חלק מהפוזיציה"},
                    {
                        ...
                        "desc": (
                            ...
                            "(בלי שלב 2 / ח1…ח5); אחרי הפתיחה: קנייה מיידית + כרטיס «החלפה הושלמה»"
                        ),
                    },
                ],
            },
                ...
                "items": [
                    {"cmd": "מניות", "desc": "הצג את הרשימה הנוכחית (תוצאת הסריקה השבועית)"},
                    {
                        ...
                        "desc": (
                            ...
                            "דירוג מומנטום/ATR/נפח + אסטרטגיות; גם אוטומטי בסוף שבוע"
                        ),
                    },
