    ...
    user_flow = [
        {
            ...
            "detail": (
                ...
                "(גרף PNG → כרטיס קוביות מדדים → הודעת פעולה קצרה עם מזומן וכן/קנה/סכום/דלג); "
                "עונים כן / קנה / סכום / דלג ועוברים להצעה הבאה. "
                "תיק לא ריק — כרטיס «סקירת תיק» (להוסיף / למכור / להחליף לכל החזקה + עצה על מזומן פנוי) "
                "ואז אותו סבב הצעות אם יש מקום למניות חדשות. "
        ...
        },
        {
            ...
            "title": "בוקר — כניסה",
            "detail": (
                f"~{entry_dual}: קנייה במחיר פתיחה למניות שאושרו בסבב ההצעות — תמונת טבלת HTML "
                "(# · סימול · שיטת כניסה · סכום · מחיר; HTML טקסט רק אם התמונה נכשלת). "
                "אם סבב ההצעות לא נגמר עד אז — מה שכבר אושר נכנס, השאר יורד להיום."
            ),
        },
        {
            "step": "ג",
            "title": "ערב — דוח",
            "detail": (
                f"~{close_dual}: תמונת טבלאות HTML אחת (סיכום הון + מוחזקות/מכירות); "
        ...
        "pipeline": [
            ...
            },
            {
                ...
                "detail": (
                    ...
                    "(2) כרטיס קוביות מדדים «הצעה N/M» "
                    "(שיטת כניסה · ציון ותנודתיות · מומנטום ומחיר · נפח · חדשות ומקורות · בדיקה לאחור — "
                    "כותרת + הסבר קצר + ערכים בכל קוביה), (3) הודעת HTML קצרה עם שיטה + מזומן "
                    "וכן/קנה/סכום/דלג — בלי חומת הסבר בטקסט. "
                    "או בדשבורד (#/plan) — עונים כן / קנה (בסכום המומלץ) / סכום מדויק / דלג, ועוברים להצעה הבאה. "
                    ...
                    "מניה חדשה בלי מזומן: מכור / החלף ואז ממשיכים בסבב. "
