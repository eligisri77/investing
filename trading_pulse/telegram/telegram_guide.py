...
def get_telegram_guide(cfg: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    tips = [
        ...
        "הניסוחים מכירה U / מכיר U הם שאלת אישור בלבד. מכירה מתבצעת רק אחרי שליחת הפקודה המדויקת מכור U.",
    ...
    return {
        ...
        "commands": [
            ...
            },
            {
                ...
                "warning": "מכירה U / מכיר U לא מבצעות מכירה. לביצוע יש לשלוח בדיוק: מכור U",
                "items": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {"cmd": "ציון שעתי AAPL", "desc": "עדכון מחיר/ציון כל X דק׳ בזמן מסחר (לפי הגדרה)"},
